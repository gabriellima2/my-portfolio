	...
	<li className="border border-transparent dark:border-white/10 rounded-sm relative">
		<a href={props.url} title={`Visitar projeto ${props.name}`}>
			...
			<ResponsiveImage
				...
				containerStyle="w-[90vw] h-[68vw] md:w-[300px] md:h-[220px] lg:w-[260px] lg:h-[190px] xl:w-[300px] xl:h-[220px]"
			/>
		</a>
	</li>
);
...
export const MyProjects = ({ projects }: MyProjectsProps) => (
	<ul className="w-full lg:min-w-[520px] xl:min-w-0 md:max-h-[55vh] md:pr-2 md:overflow-y-auto md:overflow-x-hidden grid grid-cols-1 md:grid-cols-2 gap-4 place-items-center">
